...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="row-fluid">
				<div class="span3">
					<div class="tabbable" id="tabs-212342">
						<ul class="nav nav-tabs">
							<li>
								<a href="#panel-745417" data-toggle="tab">第一部分</a>
							</li>
							<li class="active">
								<a href="#panel-522639" data-toggle="tab">第二部分</a>
							</li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane" id="panel-745417">
								<p>
									第一部分内容.
								</p>
							</div>
							<div class="tab-pane active" id="panel-522639">
								<p>
									第二部分内容.
								</p>
							</div>
				...
				<div class="span6">
					<div class="row-fluid">
						<div class="span12">
							<div class="carousel slide" id="carousel-403233">
								<ol class="carousel-indicators">
									<li class="active" data-slide-to="0" data-target="#carousel-403233">
									</li>
									<li data-slide-to="1" data-target="#carousel-403233">
									</li>
									<li data-slide-to="2" data-target="#carousel-403233">
									</li>
								</ol>
								...
								</div> <a data-slide="prev" href="#carousel-403233" class="left carousel-control">‹</a> <a data-slide="next" href="#carousel-403233" class="right carousel-control">›</a>
							</div>
							<ul class="thumbnails">
								<li class="span4">
									<div class="thumbnail">
