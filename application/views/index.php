		...
		<div class="span12">
			<div class="navbar">
				<div class="navbar-inner">
					<div class="container-fluid">
						 <a data-target=".navbar-responsive-collapse" data-toggle="collapse" class="btn btn-navbar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a> <a href="#" class="brand">逗逼网</a>
						<div class="nav-collapse collapse navbar-responsive-collapse">
							...
							<ul class="nav pull-right">
								...
								<li class="dropdown">
									 <a data-toggle="dropdown" class="dropdown-toggle" href="#">Theast<strong class="caret"></strong></a>
									<ul class="dropdown-menu">
										<li>
											<a href="#">设置</a>
										</li>
